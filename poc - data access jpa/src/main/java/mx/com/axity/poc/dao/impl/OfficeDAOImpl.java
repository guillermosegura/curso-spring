...
public class OfficeDAOImpl implements OfficeDAO
{
  ...
  {
    TypedQuery<OfficeDO> query = em.createQuery(
      "from OfficeDO as o WHERE o.territory = :territory ORDER BY o.officeCode", OfficeDO.class );
  ...
  public OfficeDO get( String officeCode )
  {
    ...
    TypedQuery<OfficeDO> query = em.createQuery( "from OfficeDO as o WHERE o.officeCode = :officeCode", OfficeDO.class );
