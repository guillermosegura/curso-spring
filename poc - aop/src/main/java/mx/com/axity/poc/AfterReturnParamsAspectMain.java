...
public class AfterReturnParamsAspectMain
{
  private static final Logger LOG = LoggerFactory.getLogger( AfterReturnParamsAspectMain.class );

  public static void main( String[] args )
  {

    ApplicationContext context = new ClassPathXmlApplicationContext( "beans-after-return-params-aspect.xml" );
