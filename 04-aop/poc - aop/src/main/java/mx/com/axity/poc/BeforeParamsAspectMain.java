...
public class BeforeParamsAspectMain
{
  private static final Logger LOG = LoggerFactory.getLogger( BeforeParamsAspectMain.class );

  public static void main( String[] args )
  {

    ApplicationContext context = new ClassPathXmlApplicationContext( "beans-before-params-aspect.xml" );
    ...
    LOG.info( "{}", op );
    String alpha = arithmeticController.alpha();
    LOG.info( "{}", alpha );
  }
