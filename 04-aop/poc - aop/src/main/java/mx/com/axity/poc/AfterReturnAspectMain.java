...
public class AfterReturnAspectMain
{
  private static final Logger LOG = LoggerFactory.getLogger( AfterReturnAspectMain.class );

  public static void main( String[] args )
  {

    ApplicationContext context = new ClassPathXmlApplicationContext( "beans-after-return-aspect.xml" );
