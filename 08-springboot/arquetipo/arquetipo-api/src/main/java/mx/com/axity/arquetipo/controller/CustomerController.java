...
public class CustomerController
{
  ...
  public ResponseEntity<GenericResponseDto<CustomerDto>> findCustomer( @PathVariable("customerNumber") Long customerNumber )
  {
  ...
  public ResponseEntity<GenericResponseDto<CustomerDto>> create( @Valid
